...
public class oreDysprosium extends Block{

	private static String blockName = "Dysprosium Ore";
	private static String blockTexture = "missing";
	private static String blockNameSafe = "oreDysprosium";
	
	public oreDysprosium()
	{
		super(Material.rock);

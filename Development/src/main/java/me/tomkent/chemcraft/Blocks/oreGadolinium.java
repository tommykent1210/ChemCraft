...
public class oreGadolinium extends Block{

	private static String blockName = "Gadolinium Ore";
	private static String blockTexture = "missing";
	private static String blockNameSafe = "oreGadolinium";
	
	public oreGadolinium()
	{
		super(Material.rock);

...
public class orePraseodymium extends Block{

	private static String blockName = "Praseodymium Ore";
	private static String blockTexture = "missing";
	private static String blockNameSafe = "orePraseodymium";
	
	public orePraseodymium()
	{
		super(Material.rock);

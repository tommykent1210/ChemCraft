...
public class GenericBlockRadioactive extends Block{
	...
	public GenericBlockRadioactive(String bName, String bTexture, String bNameSafe, String bHarvestToolClass, int bHarvestToolTier, float bHardness)
	{
		super(Material.rock);

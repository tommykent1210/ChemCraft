...
public class BlockGeneration implements IWorldGenerator {
	...
	public void generateOverworld(World world, Random rand, int x, int z) {
		@foreach ($overworld as $spawn)
		generateOre(BlockLoader.{{$spawn["ID"]}}, world, rand, x, z, {{$spawn["MinVeinSize"]}}, {{$spawn["MaxVeinSize"]}}, {{$spawn["SpawnChance"]}}, {{$spawn["MinSpawnHeight"]}}, {{$spawn["MaxSpawnHeight"]}}, Blocks.stone);
		@endforeach
	}
